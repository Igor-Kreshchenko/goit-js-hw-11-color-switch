...
},{}],"js/colorize.js":[function(require,module,exports) {
"use strict";
...
var startBtnRef = document.querySelector('button[data-action="start"]');
var stopBtnRef = document.querySelector('button[data-action="stop"]');
...
function getRandomColor() {
  var randomColorIndex = randomIntegerFromInterval(0, _colors.default.length - 1);
  return _colors.default[randomColorIndex];
}
...
},{"./colors":"js/colors.js"}],"index.js":[function(require,module,exports) {
"use strict";

require("./css/styles");

require("./js/colorize");
},{"./css/styles":"css/styles.css","./js/colorize":"js/colorize.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
